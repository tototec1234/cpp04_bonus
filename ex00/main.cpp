...
/*   Updated: 2025/08/19 23:29:27 by toruinoue        ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int main() {
	while (true) {
	    ...
	    std::cout << "1: Test Correct Polymorphism (Animal* with virtual)" << std::endl;
	    std::cout << "2: Test Polymorphic Instantiation Problems (WrongAnimal* without virtual)" << std::endl;
	    std::cout << "3: Test Inheritance-based Instantiation (WrongCat* direct)" << std::endl;
