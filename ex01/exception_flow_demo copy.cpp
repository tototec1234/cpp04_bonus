...
void demonstrateExceptionFlow() {
    ...
    try {
        ...
        int* newData = new int[SIZE_MAX / 8];  // 巨大サイズ
    ...
    std::cout << "   📊 最終状態: data = " << obj.data << std::endl;
}
...
cd /Users/toruinoue/CPP/0817cpp04/ex01 && c++ -Wall -Wextra -Werror -std=c++98 exception_flow_demo.cpp -o exception_flow_demo
